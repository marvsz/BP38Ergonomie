    ...
    oscLeftLowerLegSupport(new OptionSelectionControl())
{
    ...
    mainLayout->addWidget(new QLabel(tr("Right upper arm:")), 1, 3, 1, 1, 0);
    mainLayout->addWidget(oscRightUpperArmSupport, 1, 4, 1, 1, 0);
    ...
    mainLayout->addWidget(new QLabel(tr("Right forearm:")), 2, 3, 1, 1, 0);
    mainLayout->addWidget(oscRightForearmSupport, 2, 4, 1, 1, 0);
    ...
    mainLayout->addWidget(new QLabel(tr("Right hand:")), 3, 3, 1, 1, 0);
    mainLayout->addWidget(oscRightHandSupport, 3, 4, 1, 1, 0);
    ...
    mainLayout->addWidget(new QLabel(tr("trunk:")), 4, 3, 1, 1, 0);
    mainLayout->addWidget(oscTrunkSupport, 4, 4, 1, 1, 0);
    mainLayout->addWidget(new QLabel(tr("Right thigh:")), 5, 0, 1, 1, 0);
    mainLayout->addWidget(oscRightThighSupport, 5, 1, 1, 1, 0);
    mainLayout->addItem(new QSpacerItem(10, 0, QSizePolicy::Expanding, QSizePolicy::Fixed), 5, 2, 1, 2, 0);
    mainLayout->addWidget(new QLabel(tr("Left thigh:")), 5, 3, 1, 1, 0);
    mainLayout->addWidget(oscLeftThighSupport, 5, 4, 1, 1, 0);
    mainLayout->addWidget(new QLabel(tr("Right lower leg:")), 6, 0, 1, 1, 0);
    mainLayout->addWidget(oscRightLowerLegSupport, 6, 1, 1, 1, 0);
    mainLayout->addItem(new QSpacerItem(10, 0, QSizePolicy::Expanding, QSizePolicy::Fixed), 6, 2, 1, 2, 0);
    mainLayout->addWidget(new QLabel(tr("Left lower leg:")), 6, 3, 1, 1, 0);
    mainLayout->addWidget(oscLeftLowerLegSupport, 6, 4, 1, 1, 0);
