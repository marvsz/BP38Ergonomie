...
const QHash<QString, QVariant::Type> DBConstants::HASH_ANALYST_TYPES = QHashBuilder<QString, QVariant::Type>().add(DBConstants::COL_ANALYST_ID, QVariant::Int).add(DBConstants::COL_ANALYST_LASTNAME, QVariant::Int).add(DBConstants::COL_ANALYST_FIRSTNAME, QVariant::Int).add(DBConstants::COL_ANALYST_EXPERIENCE, QVariant::Int).add(DBConstants::COL_ANALYST_EMPLOYER_ID, QVariant::Int).add(DBConstants::COL_ANALYST_CORPORATION_ID, QVariant::Int).build();
...
const QHash<QString, QVariant::Type> DBConstants::HASH_EMPLOYEE_TYPES = QHashBuilder<QString, QVariant::Type>().add(DBConstants::COL_EMPLOYEE_ID, QVariant::Int).add(DBConstants::COL_EMPLOYEE_STAFF_NUMBER, QVariant::Int).add(DBConstants::COL_EMPLOYEE_AGE, QVariant::Int).add(DBConstants::COL_EMPLOYEE_HEIGHT, QVariant::Int).add(DBConstants::COL_EMPLOYEE_NOTE, QVariant::Int).build();
...
const QString DBConstants::COL_WORK_PROCESS_HANDEDNESS = "handedness";
...
const QString DBConstants::COL_WORK_PROCESS_TYPE_OF_GRASPING_ID = "type_of_grasping_ID";
const QHash<QString, QVariant::Type> DBConstants::HASH_WORK_PROCESS_TYPES = QHashBuilder<QString, QVariant::Type>().add(DBConstants::COL_WORK_PROCESS_ACTIVITY_ID, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_ID, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_DESCRIPTION, QVariant::String).add(DBConstants::COL_WORK_PROCESS_BEGIN, QVariant::String).add(DBConstants::COL_WORK_PROCESS_END, QVariant::String).add(DBConstants::COL_WORK_PROCESS_MTM_CODE, QVariant::String).add(DBConstants::COL_WORK_PROCESS_FREQUENCY, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_HANDEDNESS, QVariant::String).add(DBConstants::COL_WORK_PROCESS_IMPULSE_INTENSITY, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_IMPULSE_COUNT, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_WORKING_HEIGHT, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_DISTANCE, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_POSTURE_ID, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_TRANSPORTATION_ID, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_EQUIPMENT_ID, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_CONDITION_ID, QVariant::Int).add(DBConstants::COL_WORK_PROCESS_TYPE_OF_GRASPING_ID, QVariant::Int).build();
...
const QString DBConstants::COL_LOAD_HANDLING_ACTIVITY_ID = "activity_ID";
const QString DBConstants::COL_LOAD_HANDLING_PROCESS_ID = "process_ID";
const QString DBConstants::COL_LOAD_HANDLING_LOAD_HANDLING_TYPE_ID = "load_handling_type_ID";
const QHash<QString, QVariant::Type> DBConstants::HASH_LOAD_HANDLING_TYPES = QHashBuilder<QString, QVariant::Type>().add(DBConstants::COL_LOAD_HANDLING_ID, QVariant::Int).add(DBConstants::COL_LOAD_HANDLING_LOAD, QVariant::Int).add(DBConstants::COL_LOAD_HANDLING_DISTANCE, QVariant::Int).add(DBConstants::COL_LOAD_HANDLING_ACTIVITY_ID, QVariant::Int).add(DBConstants::COL_LOAD_HANDLING_PROCESS_ID, QVariant::Int).add(DBConstants::COL_LOAD_HANDLING_LOAD_HANDLING_TYPE_ID, QVariant::Int).build();
